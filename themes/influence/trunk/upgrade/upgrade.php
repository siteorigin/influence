...
function influence_supporters_upgrade_content($content){
	...
	$content['premium_summary'] = __("If you've enjoyed using Influence, you're going to love Influence Plus. It's a robust upgrade to Influence that gives you some useful features. It's a free upgrade, so you'd be crazy to miss out.", 'influence');
	...
	$content['features'][] = array(
		'heading' => __('Newsletter Updates', 'vantage'),
		'content' => __("All you need to do to receive Influence Plus is sign up to our newsletter. We use this to announce all our new free theme and plugin releases, so it's a double win.", 'vantage'),
	);
