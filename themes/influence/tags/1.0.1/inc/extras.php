 ...
 * @since influence 1.0
 */
function influence_page_menu_args( $args ) {
	$args['show_home'] = true;
	return $args;
}
add_filter( 'wp_page_menu_args', 'influence_page_menu_args' );
 ...
 * @since influence 1.0
 */
function influence_body_classes( $classes ) {
...
add_filter( 'body_class', 'influence_body_classes' );
 ...
 * @since influence 1.0
 */
function influence_enhanced_image_navigation( $url, $id ) {
